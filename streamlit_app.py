...
st.set_page_config(
    page_title="FraudShield ΓÇö Credit Card Fraud Detection",
    page_icon="≡ƒ¢í∩╕Å",
    layout="wide",
)
...
/* ΓöÇΓöÇ Hide default streamlit elements ΓöÇΓöÇ */
...
/* ΓöÇΓöÇ Streamlit overrides ΓöÇΓöÇ */
...
# ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
if api_online:
    status_html = "<span class='dot-green'>ΓùÅ</span><span class='status-text-green'>API Connected</span>"
else:
    status_html = "<span class='dot-red'>ΓùÅ</span><span class='status-text-red'>API Offline</span>"

st.markdown(f"""
<div class="navbar">
    <div class="nav-brand">
        <span class="nav-brand-icon">≡ƒ¢í∩╕Å</span>
        <div>
...
st.markdown("""
<div class="hero">
    <div class="hero-badge">ΓÜí Powered by Machine Learning</div>
...
# ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
# MAIN CONTENT ΓÇö Two columns
# ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
left, right = st.columns([3, 2], gap="large")

with left:
    st.markdown('<p class="section-header">≡ƒôé Upload Transaction Data</p>', unsafe_allow_html=True)
    ...
    if uploaded_file:
        ...
        with col_btn:
            run_predict = st.button("≡ƒöì  Analyse Transactions", disabled=not api_online)

        if run_predict:
            uploaded_file.seek(0)
            with st.spinner("Analysing transactionsΓÇª"):
                try:
                    resp = requests.post(
                        f"{API_BASE}/predict",
                    ...
                    st.error(f"Γ¥î Prediction failed: {ex}")
                    st.stop()

            st.markdown("<hr class='sep'>", unsafe_allow_html=True)
            st.markdown('<p class="section-header">≡ƒôè Results</p>', unsafe_allow_html=True)
            ...
            st.download_button(
                label="Γ¼ç∩╕Å  Download Full Results (CSV)",
        ...
        <div style="height: 180px; display: flex; align-items: center; justify-content: center;
            ...
            <div style="text-align:center; color:#475569;">
                <div style="font-size:2.5rem; margin-bottom:0.5rem;">≡ƒôä</div>
...
with right:
    ...
    <div class="card" style="margin-bottom: 1.25rem;">
        <div class="card-title">≡ƒôï Expected Format</div>
        <div class="info-pill">
            Required columns:<br>
            <code>Time</code> &nbsp;┬╖&nbsp; <code>V1</code> ΓÇô <code>V28</code> &nbsp;┬╖&nbsp; <code>Amount</code><br><br>
    ...
    st.markdown("""
    <div class="card">
        <div class="card-title">≡ƒö¼ ML Pipeline</div>
    """, unsafe_allow_html=True)

    steps = [
        ("≡ƒôÑ", "Data Ingestion",      "Pulls from MongoDB Atlas"),
        ("Γ£à", "Validation",          "Schema & drift checks"),
        ("ΓÜÖ∩╕Å", "Transformation",      "KNN imputation + scaling"),
        ("≡ƒñû", "Model Training",      "Best of LR ┬╖ DT ┬╖ RF"),
        ("≡ƒôê", "MLflow Tracking",     "Logged to DagsHub"),
    ]
    ...
    # Train expander
    st.markdown("<br>", unsafe_allow_html=True)
    with st.expander("ΓÜÖ∩╕Å  Retrain the Model"):
        st.markdown("""<p style='color:#94a3b8; font-size:0.85rem; margin-bottom:1rem;'>
            Triggers the full pipeline end-to-end. Takes 5ΓÇô15 minutes.</p>""",
            unsafe_allow_html=True)
        if st.button("Γû╢  Start Training Pipeline", disabled=not api_online):
            with st.spinner("Pipeline runningΓÇª"):
                try:
                    resp = requests.get(f"{API_BASE}/train", timeout=900)
                    resp.raise_for_status()
                    data = resp.json()
                    st.success("Γ£à Training complete!")
                    st.metric("Test F1",        data.get("test_f1", "ΓÇö"))
                    st.metric("Test Precision",  data.get("test_precision", "ΓÇö"))
                    st.metric("Test Recall",     data.get("test_recall", "ΓÇö"))
                except requests.exceptions.Timeout:
                    st.error("Timed out. The pipeline may still be running.")
                except Exception as ex:
                    st.error(f"Error: {ex}")

# ΓöÇΓöÇ Footer ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
st.markdown("""
<hr class='sep'>
